...
<head>
	...
	<meta name="description" content="Smart Rent Car">
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Smart Rent Car</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Smart Rent Car</h2></td>
					</tr>
					<tr>
						<td class="text-center">Jl. Semeru No.3, RT.4/RW.13, Sumbersari, Kec. Sumbersari, Kota Jember, Jawa Timur </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
